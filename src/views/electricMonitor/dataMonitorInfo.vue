  ...
  <div class="dataMonitorInfo">
    <el-container style="height: 100%;">
      ...
      <el-main>
        <template v-if="tableData.length>0">
          ...
          >
            ...
            >
              <!-- <img
                style="width:30px"
                src="../../../public/static/images/xianlupic.png"
                alt=""
              > -->
              <p class="mc">
                <span>名称：</span>
              ...
              <i :style="item.statu == 1?'color:#93F6F6':'color:#F56C6C'">{{ item.statu == 1?'在线':'离线' }}</i>
              <!-- <i
        ...
        <div
          v-else
          style="color:#ccc;font-size:21px"
        >
          暂无线路
        </div>
  ...
  methods: {
    ...
    getStudents(item) {
      ...
      if (item.statu == 0) {
        ...
        //         _this.linkEhars();
        this.$router.push({ name: 'dataMonitorInfoecharts', params: { nid: this.form.region, fitem: JSON.stringify(this.fitem) } })
