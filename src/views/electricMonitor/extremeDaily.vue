    ...
    <el-container style="height: 100%;">
      ...
      <el-main>
        ...
        >
          ...
          <el-table-column
            align="center"
            :label="form.eletype!=''?form.eletype=='tt'?'温度':form.eletype=='ld'?'漏电电流':'A相':'A相'"
          >
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.bbb1.max.bb1 }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ new Date(scope.row.bbb1.max.time*1000).Format('yy-MM-dd hh:mm') }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.bbb1.min.bb1 }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ new Date(scope.row.bbb1.min.time*1000).Format('yy-MM-dd hh:mm') }}</span>
              </template>
            </el-table-column>
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.bbb2.max.bb2 }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ new Date(scope.row.bbb2.max.time*1000).Format('yy-MM-dd hh:mm') }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.bbb2.min.bb2 }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ new Date(scope.row.bbb2.min.time*1000).Format('yy-MM-dd hh:mm') }}</span>
              </template>
            </el-table-column>
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.bbb3.max.bb3 }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ new Date(scope.row.bbb3.max.time*1000).Format('yy-MM-dd hh:mm') }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ scope.row.bbb3.min.bb3 }}</span>
              </template>
            </el-table-column>
            ...
            >
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{ new Date(scope.row.bbb3.min.time*1000).Format('yy-MM-dd hh:mm') }}</span>
              </template>
            </el-table-column>
