  ...
  <div class="dataMonitor">
    <el-container style="height: 100%;">
        ...
        >
          ...
          <div class="cright">
            <p>
              ...
              <span class="s2">[{{ getString1(hexCharCodeToStr(item.nid)) }}]{{ item.n_name }}</span>
            </p>
            <p>
              <span class="s1">分机台数:</span>
              <span class="s2">{{item.ext_number + "台"}}</span>
              <!-- <span
                class="s2"
                v-if="item.type == 0"
              >[F]总路单相</span>
            ...
            <p>
              ...
              <span class="s2">{{ item.n_local }}</span>
            </p>
            <p>
              <span class="s1">安装时间:</span>
              <span class="s2">{{ item.a_time }}</span>
            </p>
            <!-- <i
      ...
      <el-footer>
        <!-- 分页 -->
        <el-pagination
          v-show="fenYe.total>12?true:false"
