      ...
      <el-header>
        ...
        >
          <el-tab-pane name="first">
            <span slot="label">
              <img
                src="../../../public/static/images/ribao.png"
                alt=""
                style="width:18px;vertical-align: text-bottom;margin-right: 4px;"
              >日报</span>
          </el-tab-pane>
          <!-- <el-tab-pane name="second">
            <span slot="label">
              <img
                src="../../../public/static/images/zhoubao.png"
                alt=""
                style="width:18px;vertical-align: text-bottom;margin-right: 4px;"
              >周报</span>
          </el-tab-pane> -->
          <el-tab-pane name="third">
            <span slot="label">
              <img
                src="../../../public/static/images/yuebao.png"
                alt=""
                style="width:18px;vertical-align: text-bottom;margin-right: 4px;"
              >月报</span>
          </el-tab-pane>
          <el-tab-pane name="fourth">
            <span slot="label">
              <img
                src="../../../public/static/images/nianbao.png"
                alt=""
                style="width:18px;vertical-align: text-bottom;margin-right: 4px;"
              >年报</span>
          </el-tab-pane>
      ...
      <el-main>
        ...
        >
          ...
          <div>
            ...
            <span style="margin-left:10px;color:#ccc">(单位：kW/h)</span>
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['0']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['1']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['2']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['3']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['4']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['5']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['6']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['7']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['8']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['9']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['10']?true:false:true"
          ></el-table-column>
          ...
          <el-table-column
            ...
            align="center"
            min-width="100"
            v-if="yeartableData.length>0?yeartableData[0]['11']?true:false:true"
          ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getListday(page) {
      ...
      let uid = localStorage.getItem(username + 'uid');
      let type = "post";
      let url = this.urlb + "/api3/SourceData/GetAaData";
      let data = {
        data: {
      ...
      this.myAjax(type, url, data, res => {
        ...
        for (var j = 0; j < this.daytableData.length; j++) {
          this.daytableData[j].totalnum = 0

          this.daytableData[j].data.forEach(value => {
            this.daytableData[j].totalnum += value
            this.daytableData[j].totalnum = this.keepTwoDecimal(this.daytableData[j].totalnum)
          })
        }
    ...
    getListmonth(page) {
      ...
      this.myAjax(type, url, data, res => {
        ...
        for (var j = 0; j < this.monthtableData.length; j++) {
          this.monthtableData[j].totalnum = 0

          this.monthtableData[j].data.forEach(value => {
            this.monthtableData[j].totalnum += value
            this.monthtableData[j].totalnum = this.keepTwoDecimal(this.monthtableData[j].totalnum)
          })
        }
    ...
    getListyear(page) {
      ...
      this.myAjax(type, url, data, res => {
        ...
        for (var j = 0; j < this.yeartableData.length; j++) {
          this.yeartableData[j].totalnum = 0

          this.yeartableData[j].data.forEach(value => {
            this.yeartableData[j].totalnum += value
            this.yeartableData[j].totalnum = this.keepTwoDecimal(this.yeartableData[j].totalnum)
          })
        }
        for (const key in this.yeartableData[0]) {
          this.yeartableData[0][key] = String(this.yeartableData[0][key])
        }
        this.yeartableData[0].data = this.yeartableData[0].data.split(",")
      });
    },
    ...
    seedaypic() {
      if (this.multipleSelection1.length > 0) {
        if (this.multipleSelection1.length > 0 && this.multipleSelection1.length < 13) {
    ...
    seemonthpic() {
      if (this.multipleSelection2.length > 0) {
        if (this.multipleSelection2.length > 0 && this.multipleSelection2.length < 13) {
    ...
    seeyearpic() {
      if (this.multipleSelection3.length > 0) {
        if (this.multipleSelection3.length > 0 && this.multipleSelection3.length < 13) {
    ...
    getStudent1() {
      ...
      setTimeout(() => {
        ...
        for (var i = 0; i < this.multipleSelection1.length; i++) {
          series.push({
            name: this.multipleSelection1[i].n_name,
            type: 'line',
            smooth: true,
            symbol: 'none',
            sampling: 'average',
    ...
    getStudent2() {
      ...
      setTimeout(() => {
        ...
        for (var i = 0; i < this.multipleSelection2.length; i++) {
          series.push({
            name: this.multipleSelection2[i].n_name,
            type: 'line',
            smooth: true,
            symbol: 'none',
            sampling: 'average',
    ...
    getStudent3() {
      ...
      setTimeout(() => {
        ...
        for (var i = 0; i < this.multipleSelection3.length; i++) {
          series.push({
            name: this.multipleSelection3[i].n_name,
            type: 'line',
            smooth: true,
            symbol: 'none',
            sampling: 'average',
...
.electricBoxInfo {
  ...
  .el-header /deep/ .is-active {
    color: #93f6f6 !important;
  }
  .el-header /deep/ .el-tabs__active-bar {
    background: #93f6f6 !important;
  }

  .el-main /deep/ .el-table__fixed {
    height: 98% !important; //设置高优先，以覆盖内联样式
    background: #213777;
  }
