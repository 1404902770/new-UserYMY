  ...
  <div class="home">
    <el-row class="top">
      ...
      >
        ...
        <h2 style="margin: 0 auto">大数据监控平台</h2>
        <dv-decoration-8
          :reverse="true"
          ...
          <div class="z1_1wrap ">
            <div class="headtext">
              ...
              <span
                class="text"
                @click="tabalarm(1)"
                :style="tabalarmnum==1?'background:rgba(11, 230, 247, 0.3)':''"
              >
                <img
              ...
              <span
                class="text"
                @click="tabalarm(2)"
                :style="tabalarmnum==2?'background:rgba(11, 230, 247, 0.3);':''"
              >
                <img
              ...
              <span
                class="text"
                @click="tabalarm(3)"
                :style="tabalarmnum==3?'background:rgba(11, 230, 247, 0.3)':''"
              >
                <img
            ...
            >
              <div class="alarmbox1">
                ...
                <span>{{todayMonthYear.ben?todayMonthYear.ben:0}}</span>
              </div>
              <div class="alarmbox2">
                <span class="alarm">昨日报警：</span>
                <span>{{todayMonthYear.wang?todayMonthYear.wang:0}}</span>
              </div>
              <div class="alarmbox3">
    ...
    <el-row>
      ...
      >
        <div class="z4wrap">
          <dv-border-box-8 class="z4">
            <div class="headtext">
              <span style="float:left">
                <img
                  src="../../public/static/images/yongdiangaikuang.png"
                  alt=""
                >
                用电概况</span>
              ...
              <!-- <span
                class="text"
                @click="tabcontent(1)"
                :style="tab==1?'background:rgba(143, 222, 143, 0.56)':''"
              >
                <img
                  src="../../public/static/images/homeri.png"
                  alt=""
                >
              </span>
              <span style="padding: 8px 1px;background: #ccc;"></span>
              <span
                class="text"
                @click="tabcontent(2)"
                :style="tab==2?'background:rgba(175, 238, 238, 0.64);':''"
              >
                <img
                  src="../../public/static/images/homeyue.png"
                  alt=""
                >
              </span>
              <span style="padding: 8px 1px;background: #ccc;"></span>
              <span
                class="text"
                @click="tabcontent(3)"
                :style="tab==3?'background:rgba(250, 250, 210, 0.62)':''"
              >
                <img
                  src="../../public/static/images/homenian.png"
                  alt=""
                >
              </span> -->
            </div>
            ...
            <!-- 当日用电 -->
            <dir v-show="tab==1?true:false">
              <div
                class="elebox"
                style="background: #8fde8f8f;"
              >
                <span class="dayele">当日用电</span>
                <span>{{eledata.today?eledata.today:"0"}} kW·h</span>
              </div>
              <div
                class="elebox"
                style="background: #afeeeea3;"
              >
                <span class="dayele">昨日用电</span>
                <span>{{eledata.yestoday?eledata.yestoday:"0"}} kW·h</span>
              </div>
              <div
                class="elebox"
                style="background: #fafad29e;"
              >
                <span class="dayele">环比</span>
                <span>{{eledata.today?((eledata.today-eledata.yestoday)/eledata.yestoday*100).toFixed(2):"0"}}%</span>
              </div>
            </dir>
            <!-- 当月用电 -->
            <dir v-show="tab==2?true:false">
              <div
                class="elebox"
                style="background: #8fde8f8f;"
              >
                <span class="dayele">本月用电</span>
                <span>1909.6 kW·h</span>
              </div>
              <div
                class="elebox"
                style="background: #afeeeea3;"
              >
                <span class="dayele">上月用电</span>
                <span>1909.6 kW·h</span>
              </div>
              <div
                class="elebox"
            ...
            <!-- 今年用电 -->
            <dir v-show="tab==3?true:false">
              <div
                class="elebox"
                style="background: #8fde8f8f;"
              >
                <span class="dayele">今年用电</span>
                <span>1909.6 kW·h</span>
              </div>
              <div
                class="elebox"
      ...
      >
        ...
        >
          <div
            class="clearfix"
            style="margin-bottom:20px;margin-top: 15px;display:flex"
          >
        ...
        <!-- <dv-border-box-12 class="z1_2 clearfix">
          <div
            class="clearfix"
