      ...
      <el-header>
        ...
        >
          ...
          <div style="display: flex;height: 37px;">
            <el-button
              type="primary"
              @click="squery('1','/api3/EnergyData/machedWg1Wave')"
            >象限波动</el-button>

            <!-- <el-button
            type="primary"
            @click="squery('2','/api3/EnergyData/machedWg2Wave')"
          >2象限波动</el-button>

          <el-button
            type="primary"
            @click="squery('3','/api3/EnergyData/machedWg3Wave')"
          >3象限波动</el-button>

          <el-button
            type="primary"
            @click="squery('4','/api3/EnergyData/machedWg4Wave')"
          >4象限波动</el-button> -->
    ...
    getxianlu(geturl) {
      ...
      this.myAjax(type, url, data, res => {
        ...
        this.tableData.forEach(val => {
          if (val.name == "wg1") {
            val.name = '1象限'
          } else if (val.name == "wg2") {
            val.name = '2象限'
          } else if (val.name == "wg3") {
            val.name = '3象限'
          } else if (val.name == "wg4") {
            val.name = '4象限'
          }
        })

        this.linedata1 = res.data.data.wg1
        this.linedata2 = res.data.data.wg2
        this.linedata3 = res.data.data.wg3
        this.linedata4 = res.data.data.wg4
        ...
        //   this.linedata = res.data.data.wg3
        // } else {
